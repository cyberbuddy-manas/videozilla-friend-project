      ...
      <Box sx={{ display: "flex", flexDirection: "column", flexGrow: 1 }}>
        <Box sx={{ width: { md: "60vw", xs: "80vw" }, margin: "0 auto" }}>
          {loading ? (
            ...
            >
              {" "}
              <CircularProgress /> Uploading Video...
            </div>
          ) : (
              ...
              >
                ...
                <FormControl fullWidth>
                  ...
                  >
                    ...
                    <MenuItem value={"Vloggers"}>Vloggers</MenuItem>
                    <MenuItem value={"Animators"}>Animators</MenuItem>
                    <MenuItem value={"Educators"}>Educators</MenuItem>
                    ...
                    <MenuItem value={"Stop-Motion"}>Stop Motion</MenuItem>
                      ...
                      <Dropzone onDrop={handleFileSelect}>
                        {({ getRootProps, getInputProps }) => (
                          <div
                            {...getRootProps()}
                            className="dropzone"
                            style={{ cursor: "pointer", padding: "50px 0" }}
                          >
                            <input {...getInputProps()} />
                            <Typography
                              variant="h5"
                ...
                <Box sx={{ display: 'flex', gap: '20px' }}>
                  ...
                  >
                    Upload Thumbnail
                    <input type="file" accept="image/jpg , image/jpeg" hidden />
                  </Button>
                  {thumbnail && <img src={URL.createObjectURL(thumbnail)} alt="thumbnail" width='40px' height='40px' style={{ objectFit: 'cover' }} />}
